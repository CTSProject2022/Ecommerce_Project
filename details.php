                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="product-details-large" id="ProductPhoto">
                                <img id="ProductPhotoImg" class="product-zoom" data-image-id="<?php echo $item_title; ?>" alt="12. Aliexpress dropshipping by oberlo" data-zoom-image="<?php echo $item_image; ?>" src="<?php echo $item_image; ?>">
                                ...
                                <!-- RAY this show images of items delete the the text command to have </div>-------->
                            ...
                            <div class="single-product-content">
                                <form method="post" id="AddToCartForm" accept-charset="UTF-8" class="shopify-product-form" enctype="multipart/form-data">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <div class="product-sku">Card ID: <span class="variant-sku"><?php echo $item_id; ?></span></div>
                                        <div class="single-product-price">




                                            <!-- Price In TTD and called  ?php echo $item_price-->
                                            <div class="product-discount"><span class="price" id="ProductPrice"><span class=money>TTD$ <?php echo $item_price; ?></span></span></div>
                                        </div>
